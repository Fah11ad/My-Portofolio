            ...
            <div>
               <div className="about w-100" id="ab">
                ...
                <p><FontAwesomeIcon icon={faQuoteLeft} style={{color: '#2d545e'}} />   
                 &nbsp; I really want to build my career in software development field and I would like to shift my career path from IT Infrastructure specialist to become a software developer. I can be relied upon to help your department achieve its goals. &nbsp; <FontAwesomeIcon icon={faQuoteRight} style={{color:'#2d545e'}} /> </p>
                 <br />
